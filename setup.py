...
setup(
    ...
    package_dir={"": "."},
    package_data={},
    install_requires=['click', 'pandas==1.*,>=1.4.0', 'pydantic==1.*,>=1.9.0', 'toolz==0.*,>=0.11.2'],
    extras_require={"dev": ["bumpversion", "coverage", "flake8", "invoke==1.*,>=1.6.0", "isort", "nbsphinx", "pylint", "pytest", "sphinx", "sphinx-material", "tox", "yapf"]},
)
